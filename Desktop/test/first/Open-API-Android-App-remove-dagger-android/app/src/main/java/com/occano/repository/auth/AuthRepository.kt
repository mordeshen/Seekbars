package com.occano.repository.auth
...
import com.occano.ui.auth.state.AuthViewState
import com.occano.ui.auth.state.LoginFields
import com.occano.ui.auth.state.RegistrationFields
import com.occano.util.AbsentLiveData
import com.occano.util.ApiSuccessResponse
import com.occano.util.ErrorHandling.Companion.ERROR_SAVE_ACCOUNT_PROPERTIES
import com.occano.util.ErrorHandling.Companion.ERROR_SAVE_AUTH_TOKEN
import com.occano.util.ErrorHandling.Companion.GENERIC_AUTH_ERROR
import com.occano.util.GenericApiResponse
import com.occano.util.PreferenceKeys
import com.occano.util.SuccessHandling.Companion.RESPONSE_CHECK_PREVIOUS_AUTH_USER_DONE
